...
/* Thread priorities. */
// -----------Lab 3------------
// For lab3, the priority of any thread is PRI_MAX by default 
//
#define PRI_MIN 0                       /* Lowest priority. */
#define PRI_DEFAULT 19                  /* Default priority. */
#define PRI_MAX 19                      /* Highest priority. */
#define NUM_MLFQS 20                    /* For tests */
#define TOPMOST_S 50 // After some time period S, 
// move all the jobs in the system to the topmost queue. 
// This includes any blocked jobs.
// Set the time period S to 50 ticks.  /
// I recommend you create a constant representing S and call it something more meaningful than “S”!
